# Development and Testing Guide <br/> Message Distribution Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-users/pip-clients-msgdistribution-node.git
```
